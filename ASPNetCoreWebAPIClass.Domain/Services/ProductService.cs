...
//using ASPNetCoreWebAPIClass.Domain.Models;
using ASPNetCoreWebAPIClass.Domain.Data;
...
namespace ASPNetCoreWebAPIClass.Domain.Services
{
    ...
    public class ProductService : IProductService
    {
        ...
        public ProductService(ECommerceContext _context, IWebHostEnvironment environment, IMapper mapper)
        {
        ...
        public ApiResponse<List<ProductResponse>> GetAllProducts()
        {
            ...
            var productsResponseList = _mapper.Map<List<ProductResponse>>(productsList);
        ...
        public async Task AddProduct(ProductResponse productModel)
        {
